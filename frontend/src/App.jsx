...
import {fetchCities, addCity, removeCity, getCurrent, getForecast5d} from "./api";
import "./index.css";
        ...
        <div className="max-w-6xl mx-auto p-4 sm:p-6">
            <header className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-3xl font-extrabold text-slate-800">Weather Dashboard</h1>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                <div className="lg:col-span-2">
                    {loading ? <div className="card p-6 text-slate-600">Loading...</div> :
                        <CurrentWeather data={current}/>}
                </div>
                <Favorites items={cities} onPick={c => selectCity(c)} onRemove={c => handleRemoveFavorite(c)}/>
            </div>
